        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mb-8 animation-slideDown">
          ...
          >
            <input
              ...
              className="w-full border border-gray-300 bg-white text-gray-900 placeholder-gray-500 px-4 py-3 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition"
            ...
            <input
              required
              type="date"
              className="w-full border border-gray-300 bg-white text-gray-900 px-4 py-3 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition"
              value={formData.date}
              onChange={(e) =>
                ...
                <div className="mt-4">
                  {media.type.startsWith("image") ? (
                    <img
                      ...
                      alt="Preview"
                      className="h-56 rounded-lg object-cover border"
                    />
                  ) : (
                    <video controls className="h-56 rounded-lg border">
                      <source
                        src={URL.createObjectURL(media)}
                        type={media.type}
                      />
            ...
            <textarea
              ...
              className="w-full border border-gray-300 bg-white text-gray-900 placeholder-gray-500 px-4 py-3 rounded-lg md:col-span-2 h-32 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition"
