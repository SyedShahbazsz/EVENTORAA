...
const Home = () => {
  ...
  const fetchEvents = async () => {
    try {
      ...
      //   console.log(data); // Check image URLs here
  ...
  return (
    <div className="relative flex flex-col min-h-screen overflow-hidden">
      ...
      {/* Hero Section */}
<div className="relative z-10 mt-2 bg-black text-white rounded-3xl overflow-hidden mb-12 shadow-2xl">
      ...
      <div className="relative z-10 flex items-center justify-between mb-8 px-2 border-b border-gray-200 pb-4">
      ...
      {/* Footer Section */}
      <footer className="relative z-10 mt-auto pt-16 pb-8 border-t border-gray-200 text-center">
